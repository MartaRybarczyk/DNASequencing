...
def greedyHeuristic(S, initial_oligo, n, l, choose_next='greedy', use_phermons=False, phermone_matrix=None, backward=False):
    ...
    while solution.path_len < n and solution_l < n - l + 1:
        ...
        index = choose_next_oligo(solution.path[-1], copyS, choose_next)
        solution_l += 1
